...
import com.cn.component.MapWapper;
 ...
 * 解析请求参数json字符串 
 * 
 * 实现 WebArgumentResilver  来解析json
 * @author 周杰
 * 
 */
 ...
 */
	...
	protected Object resolveName(String name, MethodParameter parameter, NativeWebRequest webRequest) throws Exception {
        ...
        try {
            ...
            throw new JsonMappingException("输入的类型错误", e);
        }

        throw new UnsupportedOperationException(
                "参数的类型为 '" + name + "' 但是请求的类型为 [" + paramType + "], 请修改");
	}
	...
	protected void handleMissingValue(String paramName, MethodParameter parameter) throws ServletException {
	    ...
	    throw new ServletRequestBindingException(
                "错误传入的类型为 '" + paramName + "' 解析的类型为[" + paramType + "]");
	}
